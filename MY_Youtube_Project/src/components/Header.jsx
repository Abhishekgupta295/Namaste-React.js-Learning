...
const Header = () => {
    ...
    useEffect(() => {
        //make an api call after every key, but the decline 
        // api call if the difference btw 2 api call is less then 200ms
  ...
  return (
    <div className='grid grid-flow-col m-5 p-2 shadow-lg'>
        ...
        <div className='col-span-10 px-10 relative'>
            ...
            />
            <button className=' bg-gray-500 rounded-r-full p-2 text-white'>🔍</button>
